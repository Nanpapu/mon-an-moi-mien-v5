    ...
    broth: [
      {
        title: 'Nấu nước dùng',
        details: [
          'Đun sôi 4 lít nước trong nồi lớn (nồi inox đáy dày)',
          'Cho xương heo đã sơ chế vào nấu với lửa lớn',
          'Khi nước sôi (100°C), hạ lửa nhỏ vừa (95°C)',
          'Nấu liu riu 60 phút để xương ra chất ngọt',
          'Định kỳ vớt bọt mỗi 15 phút để nước dùng trong',
          'Thêm tôm khô và mực khô vào nấu thêm 30 phút',
          'Phi thơm hành tỏi với dầu ăn ở 160°C đến khi vàng',
          'Cho hành tỏi phi vào nồi nước dùng',
          'Nêm: 2 muỗng canh nước mắm + 1 muỗng canh đường + 1 muỗng cà phê bột ngọt',
          'Nếm thử và điều chỉnh vị (mặn 40%, ngọt 30%, umami 30%)',
          'Lọc bỏ cặn qua rây mịn để được nước dùng trong',
          'Giữ nước dùng sôi liu riu (95°C) trong suốt quá trình dùng',
        ],
      },
    ],
    cooking: [
      {
        ...
        details: [
          'Luộc gan heo trong nước sôi 3 phút, vớt ra ngâm ngay vào nước lạnh',
          'Luộc cật heo trong nước sôi 5 phút, vớt ra ngâm nước lạnh',
          'Chần thịt nạc trong nước dùng sôi đến khi chín tái (30 giây)',
          'Luộc tôm sú trong nước dùng đến khi vừa chín (2 phút)',
          'Xào nấm đông cô với dầu ăn và nước mắm cho thơm',
        ],
      },
    ],
    assembly: [
